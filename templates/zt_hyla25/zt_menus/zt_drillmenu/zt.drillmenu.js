function drilldownmenu(setting){	
	this.sublevelarrow = {src:setting.base + 'templates/zt_slivelight17/images/mobile/menu-arrow.png', width:'5px', top:'8px', left:'6px'} //full URL to image used to indicate there's a sub level
	this.breadcrumbarrow = setting.base + 'templates/zt_slivelight17/images/mobile/menu-arrow.png' //full URL to image separating breadcrumb links (if it's defined)
	this.loadingimage = setting.base + 'templates/zt_slivelight17/zt_menus/zt_drillmenu/images/loader.gif' //full URL to 'loading' image, if menu is loaded via Ajax
	...
	this.backarrow = setting.base + 'templates/zt_slivelight17/zt_menus/zt_drillmenu/images/left.png' //full URL to image added in front of back LI 
